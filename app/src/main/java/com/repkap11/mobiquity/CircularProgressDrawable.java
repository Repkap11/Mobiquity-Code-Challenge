...
public class CircularProgressDrawable extends Drawable
    ...
    public CircularProgressDrawable(Resources resources, int colorID, float borderWidthDP) {
        mBorderWidth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, borderWidthDP, resources.getDisplayMetrics());
        mPaint = new Paint();
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.STROKE);
        mPaint.setStrokeWidth(mBorderWidth);
        mPaint.setColor(resources.getColor(R.color.colorPrimary));
